...
**Changelog:**
- **v2.0 (2026-01-05):** Code-Analyse der bestehenden UiPath-Solution (Main.xaml, ImageAnalysisSPO.xaml), 5 kritische Blocker identifiziert, Refactoring-Empfehlungen, Zeitersparnis-Kalkulation (2-4 Wochen)
- **v1.0 (2025-12-18):** Initiale Analyse basierend auf README, Q1-Q12 beantwortet, WooCommerce-Export analysiert
...
|---|-------|-----------------|--------|
| Q1 | Welche Vision-/Text-KI soll verwendet werden? (GPT-4o, Claude, Grok, On-Prem?) | Sebastian + IT | ✅ Geklärt |
| **A1** | **Keine Einschränkungen bezüglich Compliance, on-prem, intern etc. Allerdings sollte es kostengünstig sein. Text-KI: ChatGPT mit neuem Modell. Aus ersten Tests hat sich ergeben, dass selbst Bild-/Mustererkennung mit LLMs wie ChatGPT am besten und einfachsten ist.** | - | - |
| Q2 | API-Zugang zu WooCommerce vorhanden? Welche Authentifizierung? | IT/E-Commerce-Team | ✅ Geklärt |
| **A2** | **Es gibt aktuell kein Testsystem, es gibt produktive API-Credentials und den Import können wir via CSV oder REST machen. Es gibt große Bilddateien die hochgeladen werden müssen.** | - | - |
| Q3 | SharePoint-Connection: Produktiv-Environment oder Test? Credentials? | IT | ⏳ Offen |
| Q4 | Datenschutz-Freigabe für Cloud-KI oder muss Vision-LLM On-Prem laufen? | Datenschutzbeauftragter | ✅ Geklärt |
| **A4** | **Siehe A1 - keine Einschränkungen, Cloud-KI ist ok.** | - | - |
...
| # | Frage | Ansprechpartner | Status |
|---|-------|-----------------|--------|
| Q6 | Genaue Namenskonvention für Produktordner? Beispiele für alle Varianten? | Sebastian/Shop-Manager | ⚠️ Teilweise geklärt |
| **A6** | **Produktnummer: 0002189-0090024-0000102 (Artikelnummer z.B. Viskose-Elastan 97/3% - Designnummer - Farbnummer). Für Produktordner und Dateinamen können wir uns noch etwas überlegen.** | - | - |
| Q7 | Textvorlagen und Prompt-Templates für KI-Texterstellung? | Marketing/Content | ✅ Geklärt |
| **A7** | **Gibt es noch nicht - müssen neu erstellt werden.** | - | - |
| Q8 | Taxonomie für Muster/Farben/Stil - wer pflegt? Wer gibt frei? | Sebastian/Produktmanagement | ⏳ Offen |
| Q9 | Erwartete tägliche/monatliche Produktanzahl? (Dimensionierung) | Sebastian | ✅ Geklärt |
| **A9** | **Es werden zwischen 5-10 pro Woche sein.** | - | - |
| Q10 | Human-in-the-Loop: Wer prüft finale Produkte? Approval-Workflow? | Sebastian/Shop-Team | ✅ Geklärt |
| **A10** | **In einem separaten Formular, entweder über ein Tool wie PowerApps, oder in UiPath gibt es ja auch so ein Art Approval Tool wo man Formulare bauen kann.** | - | - |
| Q11 | Umgang mit Varianten (Farbstellungen)? Einzelprodukt vs. Produktgruppe? | E-Commerce-Team | ✅ Geklärt |
| **A11** | **Es gibt keine Varianten.** | - | - |
| Q12 | WooCommerce CSV-Import vs. REST API? Welche Methode bevorzugt? | IT/E-Commerce | ✅ Geklärt |
| **A12** | **Beides möglich - CSV oder REST. WooCommerce-Export kann als Referenz-Schema dienen.** | - | - |

### Nice-to-have (Kann später geklärt werden)

| # | Frage | Ansprechpartner | Status |
|---|-------|-----------------|--------|
| Q13 | Feedback-Loop: Sollen Korrekturen in Prompt-Verbesserungen fließen? | Produktmanagement | ✅ Geklärt |
| **A13** | **Aktuell noch nicht - spätere Phase.** | - | - |
| Q14 | Automatische SEO-Tag-Generierung gewünscht? | Marketing/SEO | ⚠️ Teilweise geklärt |
| **A14** | **Es wird mit Etsy, Pinterest, Instagram und Facebook synchronisiert - SEO-Tags können später hinzugefügt werden.** | - | - |
...
**Version:** 2.0  
**Nächste Schritte:**
1. ~~Rückfragen Q1-Q12 klären~~ → **Größtenteils geklärt (siehe Antworten A1-A14)**
2. Noch offen: Q3 (SharePoint Credentials), Q5 (Orchestrator-Lizenz), Q8 (Taxonomie-Pflege), Q15 (Monitoring)
3. Workshop: Finale Namenskonvention für Produktordner (Q6 teilweise geklärt)
4. API-Zugänge bereitstellen (WooCommerce bereits vorhanden)
5. Entwicklungsstart: Refactoring bestehender Code

**Wichtige Erkenntnisse aus v1.0:**
- ✅ Cloud-KI erlaubt (ChatGPT/GPT-4o)
- ✅ 5-10 Produkte/Woche
- ✅ Keine Varianten
- ✅ REST API oder CSV für WooCommerce
- ⚠️ Namenskonvention teilweise definiert (Format: Artikelnr-Designnr-Farbnr)
- ⚠️ Kein Testsystem für WooCommerce (nur Prod)

**Erstellt mit:** GitHub Copilot + Bestandscode-Analyse (Main.xaml, ImageAnalysisSPO.xaml, project.json)
